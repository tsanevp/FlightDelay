...
F1_Filtered_PreJoin = FILTER Filtered_Flight1 BY cancelled1 == 0 AND diverted1 == 0 AND (origin1 == 'ORD' AND dest1 != 'JFK');
F2_Filtered_PreJoin = FILTER Filtered_Flight2 BY cancelled2 == 0 AND diverted2 == 0 AND (origin2 != 'ORD' AND dest2 == 'JFK');
...
-- Filter and ensure dates for ONLY F1 are between 06/2007 and 05/2008
